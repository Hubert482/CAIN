...
model_arg.add_argument('--n_resblocks', default="12")
model_arg.add_argument('--n_resgroups', default="6")
...
learn_arg.add_argument('--val_batch_size', type=int, default=16)
learn_arg.add_argument('--test_batch_size', type=int, default=16)
